"""
Django settings for ambulance_project project.
...
SECRET_KEY = "django-insecure-i^m5e2h!u1k4n!xc2g^o0243y9e-4p3hjqezzqg*1b7sok4#h4"
...
# Geoapify API Key
GEOAPIFY_API_KEY = "your-geoapify-api-key-here"  # Replace with actual API key

# Flag to use dummy data instead of real API
USE_DUMMY_DATA = True
